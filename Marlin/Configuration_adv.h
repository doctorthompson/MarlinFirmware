 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 30
 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD                75 // (seconds)
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (9*60)    // (seconds) Time without extruder movement to trigger protection
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN         1 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_NAME_2 "Q4"
  #define TRAMMING_POINT_NAME_3 "Q1"
  #define TRAMMING_POINT_NAME_4 "Q2"
  ...
  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, Y_CENTER, 5 } // Move the nozzle out of the way for adjustment
...
//#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.02, 0.02, 0 } // (linear=mm, rotational=°) One value for each linear axis
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    // Set a convenient positiWIZARDon to do the calibration (probing point and nozzle/bed-distance)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define SDCARD_RxEADONLY                 // Read-only SD card (to save over 2K of flash)
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 550   // Maximum interval between clicks, in milliseconds.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.014 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.014        // (mm) Compression length applying to all extruders
  #endif
 ...
 * Requires AUTO_BED_LEVELING_3POINT, LINEAR, or BILINEAR
 */
...
//#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP           1   // (mm) Default swap retract length (positive value)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS         13  // Number of alert beeps to play when a response is needed.
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Home & Level"
  ...
  #define MAIN_MENU_ITEM_3_GCODE "G26 B50 F1.75 H200 S0.4 K1 L0.2"
  #define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Print PETG grid"
  #define MAIN_MENU_ITEM_4_GCODE "G26 B80 F1.75 H235 S0.4 K1 L0.2"
