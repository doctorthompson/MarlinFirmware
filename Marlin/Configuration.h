...
#define STRING_CONFIG_H_AUTHOR "(@doctorthompson)"  //  Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 LT"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
// #define MACHINE_UUID "19FFA00E-AF4A-0845-5D7F-F6FDF50020C2"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  15.9, 15.9 }
    #define DEFAULT_Ki_LIST {  1.79, 1.79 }
    #define DEFAULT_Kd_LIST {  35.3, 35.3 }
  #else
    #define DEFAULT_Kp  15.9
    #define DEFAULT_Ki  1.79
    #define DEFAULT_Kd  35.3
  #endif
#else
...
/**
 * Model Predictive Control for hotend5
 *
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 163.2
  #define DEFAULT_bedKi 29.14
  #define DEFAULT_bedKd 609.3
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 900, 900, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.95, -7.68, -0.54 }
...
#define XY_AFTER_HOMING { 50, 50 }  // (mm) Move to an XY position after homing (and raising Z)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.24  // (mm) Default layer height for the G26 Mesh Validation Tool.
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 6     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 48, 30 }  // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       3.0        // (mm) Z height of nozzle between leveling points
  #define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.005  // (mm)
...
#define HOMING_FEEDRATE_MM_M { (133*60), (133*60), (25*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 133   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
