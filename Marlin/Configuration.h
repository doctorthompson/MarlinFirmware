...
#define STRING_CONFIG_H_AUTHOR "(doctorthompson, ender config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 423.25 } // direct drive bondtech
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -9.7, -4.44 }
