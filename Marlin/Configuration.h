...
#define CUSTOM_MACHINE_NAME "Ender-3Z"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415.5 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0642 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -9.2, -1.885 }
...
#define Z_PROBE_FEEDRATE_SLOW (11*60)
...
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (11*60) }
